  ...
  render() {
    return(
      <div className="LandingPage">
        ...
        <p>When you sign up you'll be able to enter in an email address, name, and message for a person you want to create an allowance allocation for.</p>
        <p>That person will be sent an email to a link where they will be able to create an account as well.</p>
        <p>UPDATE THISOnly once both accounts are active will you be able to fully utilize the web application where the allowance giver can create tasks and set their worth and the receiver can mark tasks as done and allowance has been received.</p>
